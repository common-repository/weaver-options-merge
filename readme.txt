...
Tags: Weaver,theme options,merge,Aspen
Donate link: http://bit.ly/1BNjMjG
...
== Screenshots ==
1. The plugin admin page, showing the Weaver II choices.
2. The merge page, with options selected from both files.
